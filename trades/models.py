...
class Trade(models.Model):
    ...
    trade_amount = MoneyField(max_digits=10,
                              decimal_places=2,
                              default_currency='USD',
                              validators=[MinMoneyValidator(1), ])

    opening_price = MoneyField(max_digits=10,
                               decimal_places=2,
                               default_currency='USD',
                               validators=[MinMoneyValidator(1), ])
    ...
    closing_price = MoneyField(max_digits=10,
                               decimal_places=2,
                               default_currency='USD',
    ...
    def realised_pl(self):
        if self.closing_price is None:
            ...
            realised_pl = (self.units_transacted *
                           self.closing_price) - self.trade_amount
            return realised_pl
    ...
    def __str__(self):
        return f'{self.date_opened} {self.position} \
